...
2) Инструмент для разметки собранного датасета с возможность генерации автоматической предразметки
...
5) Реализацию и обучени BiLSTM классификатора типов финансовых таблиц
